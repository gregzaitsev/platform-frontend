...
const BackupCodesWidgetBase: React.FunctionComponent<IWidgetBaseProps & IDispatchProps> = ({
  startBackupProcess,
  widgetDataTestId,
  widgetText,
  buttonDataTestId,
  ...
  <section data-test-id={widgetDataTestId} className={styles.accountSetupSection}>
    {Array.isArray(widgetText) ? (
      ...
      <p className={styles.accountSetupText}>{widgetText}</p>
    )}
...
> = ({ backupCodesVerified, startBackupProcess }) =>
  backupCodesVerified ? (
