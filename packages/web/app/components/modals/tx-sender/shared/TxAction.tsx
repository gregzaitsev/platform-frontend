...
const TxActionLayout: React.FunctionComponent<TComponentProps> = ({ type, goToWallet }) => {
  switch (type) {
...
const TxAction = compose<TComponentProps, IExternalProps>(
...
export { TxAction, TxActionLayout };
